# Django settings for medic_site project.
...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/shreyas/workspace/chands279/MEDIC-Site/sqlite.db',  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'dv)mdb-gi0n$*1)_8_m2xz$rcief_^e5mvho1do!!*@5vbh9(d'
